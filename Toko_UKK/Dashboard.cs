...
namespace Toko_UKK
{
    public partial class Dashboard : Form
    {
        ...
        MySqlConnection connection = new MySqlConnection("server=localhost;user=root;password=;database=db_sekolah; Convert Zero Datetime=True");
        ...
        public void Tampil(string valueToSearch)
        {
            ...
            dataGridView1.Columns[1].HeaderText = "Harga Buku";
            dataGridView1.Columns[2].HeaderText = "Judul Buku";
            dataGridView1.Columns[3].HeaderText = "Jenis Buku";
            dataGridView1.Columns[4].HeaderText = "Tanggal Pembelian";
            dataGridView1.Columns[5].HeaderText = "Tanggal Masuk Buku";
            dataGridView1.Columns[6].HeaderText = "Kode Buku";
